...
- [docs/design.md](docs/design.md)：设计目标、关键取舍与架构说明，改动前建议先读；
- [AGENTS.md](AGENTS.md)：面向 AI 协作的维护约定（红线、目录速览、代码与提交风格）。
...
仓库内的 [demo/](demo/) 是一个独立的 Vite 消费工程，以 `file:` 方式依赖本仓库，用于模拟真实项目的集成与翻译效果。
...
- **工作台自身**：界面语言暂固定为简体中文；全屏编辑与单元格内的逐条 AI 按钮仍为占位；
